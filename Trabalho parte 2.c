...
int main(void) {
    ...
    if (strcmp(repr, "M") == 0 || strcmp(repr, "m") == 0) { // MATRIZ ADJ
        int vertice;
        char busca[2];
        ...
        if (strcmp(busca, "H") == 0 || strcmp(busca, "h") == 0) { // Dijkstra_Matriz_Heap
        ...
        if (strcmp(busca, "V") == 0 || strcmp(busca, "v") == 0){ // Dijkstra_Matriz
    ...
    else if (strcmp(repr, "L") == 0 || strcmp(repr, "l") == 0) { // LISTA ADJ
        char busca[2];
        int vertice;
